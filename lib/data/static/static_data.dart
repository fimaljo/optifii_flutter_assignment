...
abstract final class StaticData {
  ...
  static const brands = <Brand>[
    ...
    Brand(
      ...
      name: 'Zomato',
      categoryId: 'food',
      logoAsset: 'assets/brands/zomato.png',
      brandColor: Color(0xFFE23744),
      discountPercent: 6,
      startingPrice: 300,
      validityMonths: 6,
      isPopular: true,
    ...
    Brand(
      ...
      name: 'Nykaa',
      categoryId: 'fashion',
      logoAsset: 'assets/brands/nykaa.png',
    ...
    Brand(
      ...
      name: 'BigBasket',
      categoryId: 'grocery',
      logoAsset: 'assets/brands/bigbasket.png',
      brandColor: Color(0xFF84C225),
      discountPercent: 6,
      startingPrice: 500,
      validityMonths: 6,
      isPopular: true,
    ...
    Brand(
      ...
      name: "Domino's",
      categoryId: 'food',
      logoAsset: 'assets/brands/dominos.png',
    ...
    Brand(
      ...
      name: 'Lifestyle',
      categoryId: 'fashion',
      logoAsset: 'assets/brands/lifestyle.png',
